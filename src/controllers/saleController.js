...
module.exports.getAllSale = async (req, res) => {
    try{
        ...
        let summary=await Sale.aggregate([{
            $group: {
                _id:null,
        ...
        console.log(Object.values(summary)[0].total_payable)
...
module.exports.postSaleInsertForm = async (req, res) => {
    let { customer, item, itemPrice, itemUnit, itemTotal, payable, discount, paid, due } = req.body
    try {
